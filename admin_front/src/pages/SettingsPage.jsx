    ...
    <div className="fade-in">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">إدارة الإعدادات العامة للمنصة وقواعد البيانات</p>
        </div>
      </div>
      ...
      <div className="grid-2">
        <div className="card">
          ...
          <div className="form-group">
            <label className="form-label">الحد الأقصى للتحويل اليومي (د.ج)</label>
          ...
          <div className="form-group" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 0', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)', margin: '20px 0' }}>
            <div>
              <div style={{ fontWeight: 600, fontSize: 14 }}>وضع الصيانة</div>
              <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>إيقاف جميع العمليات للمستخدمين</div>
            </div>
          ...
          <div className="form-group" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 0 12px 0', borderBottom: '1px solid var(--border)', marginBottom: 20 }}>
            <div>
              <div style={{ fontWeight: 600, fontSize: 14 }}>الموافقة التلقائية</div>
              <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>قبول التحويلات تلقائياً دون مراجعة</div>
            </div>
            <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
          ...
          <button className="btn btn-primary" onClick={handleSave} disabled={saving}>
            {saving ? <span className="spinner" style={{width:16,height:16,borderWidth:2}} /> : <><FiSave size={14} style={{marginLeft:4}}/> حفظ الإعدادات</>}
          </button>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          <div className="card">
            <div className="card-header">
              <span className="card-title">قاعدة البيانات</span>
              <FiDatabase color="var(--text-muted)" />
            </div>
            <p style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 16 }}>
              النسخ الاحتياطي لقاعدة البيانات واستعادة البيانات السابقة.
            </p>
            <div style={{ display: 'flex', gap: 8 }}>
              <button className="btn btn-secondary" style={{ flex: 1, justifyContent: 'center' }}>إنشاء نسخة احتياطية</button>
            </div>
          </div>

          <div className="card">
            <div className="card-header">
              <span className="card-title">صلاحيات المستخدمين</span>
              <FiLock color="var(--text-muted)" />
            </div>
            <p style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 16 }}>
              تحديد الصفحات التي يمكن لكل دور الوصول إليها (يطبق على كل المستخدمين من نفس الدور).
            </p>
            ...
            {selectedRole && (
              <>
                ...
                <button className="btn btn-primary" style={{ width: '100%', justifyContent: 'center' }} onClick={handleSavePerms} disabled={saving}>
                  حفظ الصلاحيات
                </button>
              </>
            )}
          ...
          <div className="card" style={{ borderColor: 'var(--danger)' }}>
            <div className="card-header">
              <span className="card-title" style={{ color: 'var(--danger)' }}>المنطقة الخطرة</span>
